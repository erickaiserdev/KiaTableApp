...
function site_scripts() {
  global $wp_styles; // Call global $wp_styles variable to add conditional wrapper around ie stylesheet the WordPress way
    ...
    // Adding scripts file in the footer
    wp_enqueue_script( 'custom-js', get_template_directory_uri() . '/assets/scripts/custom_scripts.js', array( 'jquery' ), filemtime(get_template_directory() . '/assets/scripts'), true );
    ...
    // Register main stylesheet
    wp_enqueue_style( 'custom-css', get_template_directory_uri() . '/assets/styles/custom_style.css', array(), filemtime(get_template_directory() . '/assets/styles'), 'all' );
